...
public class KafkaAdminClient {
    ...
    public void checkTopicsCreated() {
        ...
        Integer multiplier = retryConfigData.getMultipler().intValue();
    ...
    public void checkShemaRegistry() {
        int retryCount = 1;
        Integer maxRetry = retryConfigData.getMaxAttempts();
    ...
    private HttpStatus getSchemaRegistryStatus() {
        try {
            return webClient
                    ...
                    .uri(kafkaConfigData.getSchemaRegisteryUrl())
                    .exchangeToMono(clientResponse -> Mono.just(HttpStatus.valueOf(clientResponse.statusCode().value())))
                    .block();
        } catch (Exception e) {
