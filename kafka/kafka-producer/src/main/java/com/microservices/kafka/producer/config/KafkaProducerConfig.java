...
import com.microservices.appconfigdata.config.KafkaProducerConfigData;
...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(kafkaConfigData.getSchemaRegisteryUrlKey(), kafkaConfigData.getSchemaRegisteryUrl());
